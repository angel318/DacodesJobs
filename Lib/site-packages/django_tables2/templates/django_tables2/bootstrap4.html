            ...
            {% if table.show_header %}
                ...
                {% for column in table.columns %}
                    <th {{ column.attrs.th.as_html }}>
                        {% if column.orderable %}
                            <a class="text- card-link" href="{% querystring table.prefixed_order_by_field=column.order_by_alias.next %}" data-toggle="tooltip" data-placement="top" title="Ordenar desde el servidor">{{ column.header }}</a>
                        {% else %}
                            {{ column.header }}
                        {% endif %}
                    </th>
